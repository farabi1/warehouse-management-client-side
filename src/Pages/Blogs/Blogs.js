...
const Blogs = () => {
  return (
    <div>
      <Header></Header>
      <div className=" bg-stone-100 mx-20 p-5 border rounded-md shadow-sm">
        <h1 className=' text-2xl text-indigo-800'> Difference between javascript and nodejs</h1><br />
        ...
        <br />
        <h1 className=' text-2xl text-indigo-800'> When should you use nodejs and when should you use mongodb</h1> <br />
        <h1>Nodejs is a Javascript engine that we can write any application you want with . It runs your Javascript code. Most commonly, it is used to build servers that can respond to web requests, though it can be used for lots of other types of code too.
          ...
          MongoDB offers an API library that runs within a Nodejs application to give us programmatic access to MongoDB so we can create databases and then add, query, update or delete data from the MongoDB database. MongoDB also has API libraries for other programming environments such as Python, Java, etc

          These two technologies are for different parts of a typical web server system. we don't substitute one for the other. Instead, we can use them together.
        ...
        <h1 className=' text-2xl text-indigo-800'> Differences between sql and nosql databases.</h1> <br />
        ...
        <h1 className=' text-2xl text-indigo-800'> What is the purpose of jwt and how does it work</h1> <br />
        ...
        <h1 className=' text-2xl text-indigo-400'>
          StackOverFlow :::<br></br> <br></br>https://stackoverflow.com/questions/72134063/how-can-i-remove-any-specific-installed-node-package
        </h1><br /> <br />
